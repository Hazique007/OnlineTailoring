...
const Customize = () => {
  ...
  const handleProceed = async () => {
    ...
    //   const response = await axios.post("https://backend-for-doorstep-stitching.onrender.com/orders/create", orderData);
      ...
      <div className="px-[11px] mt-[17px] pb-24">
        ...
        <div className="w-full text-center mt-[23px] gap-y-3 flex flex-col items-center justify-center">
          ...
          <div className="relative w-[359px] h-[282px] overflow-hidden rounded-[10px] px-4">
            <img
              src={`https://backend-for-doorstep-stitching.onrender.com/uploads/${productItem.images[currentImageIndex]}`}
