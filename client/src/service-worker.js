...
registerRoute(
  ({ url }) =>
    url.origin === "https://doorsteptailoring-hazique.onrender.com/api/v1/landing/getLandingPageImages", // Replace with your API's origin
  new StaleWhileRevalidate({
    cacheName: "api-cache",
...
registerRoute(
  ({ url }) =>
    url.origin === "https://doorsteptailoring-hazique.onrender.com/api/v1/landing/getFashionPageImages", // Replace with your API's origin
  new StaleWhileRevalidate({
    cacheName: "api-cache",
    plugins: [new ExpirationPlugin({ maxEntries: 50 })],
  })
...
registerRoute(
  ({ url }) =>
    url.origin === "https://doorsteptailoring-hazique.onrender.com/api/v1/landing/getTrendingPageImages", // Replace with your API's origin
  new StaleWhileRevalidate({
    cacheName: "api-cache",
    plugins: [new ExpirationPlugin({ maxEntries: 50 })],
  })
...
registerRoute(
  ({ url }) =>
    url.origin === "https://doorsteptailoring-hazique.onrender.com/api/v1/category/fetchcategories", // Replace with your API's origin
  new StaleWhileRevalidate({
    cacheName: "api-cache",
    plugins: [new ExpirationPlugin({ maxEntries: 50 })],
  })
