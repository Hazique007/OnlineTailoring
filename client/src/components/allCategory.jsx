  ...
  const fetchCategories = async () => {
    try {
      ...
      const maleResponse = await axios.get(
        "https://backend-for-doorstep-stitching.onrender.com/api/v1/category/fetchcategories",
        { params: { gender: "Male" } }
      );
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {categories.male.length > 0 ? (
                categories.male.map((category) => (
                  ...
                  >
                    <img
                      src={`https://backend-for-doorstep-stitching.onrender.com/uploads/${category.categoryImages}`}
