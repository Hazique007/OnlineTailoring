...
const OrderSummaryCard = ({ order, removeOrder }) => {
  ...
  const handleRemove = async () => {
    try {
      setLoading(true);
      await axios.delete(`https://doorsteptailoring-haziquekhan.onrender.com/orders/${order._id}`);
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={`https://doorsteptailoring-haziquekhan.onrender.com/uploads/${images?.[0]}`}
          alt="Product"
          style={{
            width: "100%",
