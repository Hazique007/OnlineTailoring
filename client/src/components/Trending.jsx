  ...
  const getTrendingImages = async () => {
    try {
      const { data } = await axios.get(
        "https://doorstep-stitching-backend.onrender.com/api/v1/landing/getTrendingPageImages"
      );
            ...
            >
              {item.trendingImage ? (
                <img
                  ...
                  src={`https://doorstep-stitching-backend.onrender.com/uploads/${item.trendingImage}`}
