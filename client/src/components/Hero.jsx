  ...
  const getLandingImages = async () => {
    try {
      ...
      const { data } = await axios.get(
        "https://online-tailoring-haziquebackend.onrender.com/api/v1/landing/getLandingPageImages"
      );
          ...
          >
            {landingArray.map((image, index) => (
              <div key={index} className="w-full h-[182px] flex-shrink-0">
                <img
                  src={`https://online-tailoring-haziquebackend.onrender.com/uploads/${image.image}`}
