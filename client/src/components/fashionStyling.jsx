  ...
  const fetchFashionImages = async () => {
    try {
      const { data } = await axios.get(
        "https://doorstep-stitching-backend.onrender.com/api/v1/landing/getFashionPageImages"
      );
              ...
              {image.fashionImage ? (
                <>
                  <img
                    ...
                    src={`https://doorstep-stitching-backend.onrender.com/uploads/${image.fashionImage}`}
                    alt={image.category}
                  />
                </>
              ) : (
